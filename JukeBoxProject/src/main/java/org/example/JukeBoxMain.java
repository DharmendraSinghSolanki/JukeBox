...
public class JukeBoxMain extends JDBCConnection{
    ...
    public static void main(String[] args) {
        ...
        ChooseByOptions option=new ChooseByOptions();
                ...
                while (exist == 1) {
                    ...
                    if (y == 5) {
                        ...
                        while (p == 2) {
                            ...
                            list1=getMethod.getAllUrl(obj.con);
                            // for(int j=0;j<list1.size();j++){
                            //   simpleAudioPlayer=new SimpleAudioPlayer(list1.get(j));
                            SimpleAudioPlayer.MusicControl(list1);
